...
macro(CommonSetup)
    ...
    IF(UNIX)
        ...
        if (APPLE)
            ...
            if (${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
                ...
                set(CMAKE_CXX_FLAGS "-stdlib=libc++ -Wno-documentation -fopenmp -Wno-unknown-warning-option ${CMAKE_CXX_FLAGS}")
                set(CMAKE_EXE_LINKER_FLAGS "-fopenmp=libiomp5 ${CMAKE_EXE_LINKER_FLAGS}")
    ...
    ELSE()
        ...
        set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D_WIN32_WINNT=0x0600 /std:c++17 /GS /W4 /wd4100 /wd4505 /wd4820 /wd4464 /wd4514 /wd4710 /wd4571 /Zc:wchar_t /Zc:inline /fp:precise /D_SCL_SECURE_NO_WARNINGS /D_CRT_SECURE_NO_WARNINGS /D_UNICODE /DUNICODE /WX- /Zc:forScope /Gd /EHsc ")
        set (CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /NXCOMPAT /DYNAMICBASE /INCREMENTAL:NO ")

        if("${BUILD_TYPE}" STREQUAL "debug")
          set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /ZI /D_DEBUG /MDd /RTC1 /Gm /Od ")
