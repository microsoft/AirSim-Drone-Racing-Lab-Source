...
namespace simple_rrt_planner
{
    ...
    public:
        ...
        uint64_t SerializeSelf(std::vector<uint8_t>& buffer, const std::function<uint64_t(const T&, std::vector<uint8_t>&)>& value_serializer) const
        {
            ...
            sdf_utils::SerializeFixedSizePOD<int64_t>(parent_index_, buffer);
            // Serialize the child indices
            sdf_utils::SerializeVector<int64_t>(child_indices_, buffer, sdf_utils::SerializeFixedSizePOD<int64_t>);
            // Serialize the value
        ...
        uint64_t DeserializeSelf(const std::vector<uint8_t>& buffer, const uint64_t current, const std::function<std::pair<T, uint64_t>(const std::vector<uint8_t>&, const uint64_t)>& value_deserializer)
        {
            ...
            const std::pair<uint8_t, uint64_t> initialized_deserialized = sdf_utils::DeserializeFixedSizePOD<uint8_t>(buffer, current_position);
            ...
            const std::pair<int64_t, uint64_t> parent_index_deserialized = sdf_utils::DeserializeFixedSizePOD<int64_t>(buffer, current_position);
            ...
            const std::pair<std::vector<int64_t>, uint64_t> child_indices_deserialized = sdf_utils::DeserializeVector<int64_t>(buffer, current_position, sdf_utils::DeserializeFixedSizePOD<int64_t>);
