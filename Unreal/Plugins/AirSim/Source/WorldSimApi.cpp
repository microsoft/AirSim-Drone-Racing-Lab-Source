...
bool WorldSimApi::setMeshMaterialFromTexture(const std::string& object_name, const std::string& texture_path)
{
    bool success = false;
...
bool WorldSimApi::setMeshMaterial(const std::string& object_name, const std::string& material_name)
{
    bool success = false;
